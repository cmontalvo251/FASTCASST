...
HARDWARESOURCES=$(I2CSOURCES) $(SERIALSOURCES) $(RCINPUTSOURCES) $(RCOUTPUTSOURCES) $(PWMSOURCES) $(IMUSOURCES) $(GPSSOURCES) $(BAROTEMPSOURCES) $(RCIOSOURCES) $(UARTSOURCES) $(ADCSOURCES) $(HWSOURCES) $(UTILSOURCES) $(UBLOXSOURCES) $(MS5611SOURCES)
##MODELING
