...
#define USEUSB
#define ONLYROLLPITCH
#define NOPANIC
#define DIFFERENTIAL -1.0 //make 1.0 for meta1 and -1.0 for meta2 or 0 for no differential
...
int main(int argc, char* argv[]){
  ...
  while (1) {
	...
	if (oh_shit < 1800) {
	  ...
	  MOTORSOUT[0] = throttle + DIFFERENTIAL*pm_rudder*(SERVO_MAX-SERVO_MID);
