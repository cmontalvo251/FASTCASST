...
int main(int argc, char *argv[])
{
  ...
  //rcout.PWMOUTPUTS[8] = 8; == This is for the pusher
  ...
  while (true)
	...
	//PWM outputs
	printf("%d %d %d %d %d %d %d %d ",bottom_front_left_pwm,bottom_front_right_pwm,bottom_back_right_pwm,bottom_back_left_pwm,top_front_left_pwm,top_front_right_pwm,top_back_right_pwm,top_back_left_pwm);
	#ifdef USERECONFIG
