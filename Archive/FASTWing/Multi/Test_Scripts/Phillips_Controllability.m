function [A,B] = Phillips_Controllability()
...
C_L_0_T = 0.393; 
C_D_0_T = 0.05;
C_m_0_T = 0.0; %%%Double check this
C_D_u = 0.0; %%%%Double check this
C_L_alpha_T = 4.4;
C_D_alpha_T = 0.35;
C_m_alpha_T = -0.68; 
C_m_alpha_hat = -4.35; %%%%%%%%%%%%%%%%%%%%%%%
C_m_u = 0.0; %%%%Double check this
C_L_q_T = 3.8;
C_m_q_T = -9.95;
...
%%%Longintudinal A_long matrix - page 838 - Longitudinal States (
A_long = zeros(6,6);
A_long(1,1) = R_x_mu;
...
%%%%Longitudinal B_long matrix - Longitudinal Controls - 
B_long = zeros(6,2);
...
%%%Lateral A matrix - Page 886 - Lateral State - ()
lxz = Ixz/Ixx;
lzx = Ixz/Izz;
A_lat = zeros(6,6);
A_lat(1,1) = R_y_beta;
...
%%%Lateral B Matrix - Lateral Controls - ()
R_y_da = fw*C_y_da;
R_y_dr = fw*C_y_dr;
R_l_da = fxx*C_l_da;
R_l_dr = fxx*C_l_dr;
