...
# WOODEN DRONE (ARDUINO IDE):
  ...
  * [x] Make all of the sensor specific items happen inside the sensor class. @done (23-03-02 20:46)
...
# META (FASTCASST++):
  ...
  * [x] Simulation of waypoint flights of single airplane @done (22-11-10 21:00)
