//Barometer for altitude code for meta
#include <unistd.h>
...
int main(int argc, char *argv[]){
  ...
  OUTPUT.zeros(21,1,"OUTPUT MATRIX");
  ...
  while (1) {
    ...
    ////POLL PITOT PROBE AT 10 HZ//////////////
    if ((currentTime - lastADCTime)/1000000.0 > 0.1) {
    ...
    if ((currentTime - lastBaroTime)/1000000.0 > 0.1) {
    ...
    if ((((currentTime - dataTime)/1000000.0) > 0.02) && (FILEOPEN == 1)) {
      ...
      OUTPUT.set(21,1,baroPressure/1000.0);
