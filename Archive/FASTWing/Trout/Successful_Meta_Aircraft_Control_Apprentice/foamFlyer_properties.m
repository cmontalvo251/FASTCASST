...
%%%%%%%%%%%%%%%%%ALL OF THESE COEFFICIENTS ARE SHIT!!!!%%%%%%%
%%%%%%%%%%%%%%%%%THE GRAD STUDENT WHO RAN XFLR5 PROBABLY DOESNT"T
%KNOW HOW AN AIRPLANE FLIES. DO NOT TRUST THESE NUMBERS%%%%%%%%%%%
%%%%%%%%%%BTDUBS, CMA IS POSITIVE. THATS WRONG BECAUSE I FLEW THE
%A/C AND IT FLEW UNTIL I CONNECTED TO ANOTHER A/C. %%%%%%%%%%%%%%
%%%%USE ACICA - get_aircraft_coefficients.py
...
%C_L_alpha = 4.3673 %From flat plate theory
C_L_q = 4.589;
C_L_de = 0.2167;
C_D_0 = 0.003;
C_D_alpha = 1.3537;
