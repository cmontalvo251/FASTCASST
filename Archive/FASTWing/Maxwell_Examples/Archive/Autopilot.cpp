//Autopilot for roll and pitch code for meta
#include <unistd.h>
...
int main(int argc, char *argv[]){
  ...
  printf("Updating Barometer....this will take 2 seconds I think \n");
  barometer.update();
  #endif
  ///////////////////////////////////////////////
  ...
  while (1) {
    ...
    ///////////POLL BAROMETER AT 10 HZ/////////////
    #ifdef USEBARO
    if ((currentTime - lastBaroTime)/1000000.0 > BAROPERIOD) { //DO NOT GO FASTER THAN 1 HZ. BAROMETER TENDS TO SLOW THINGS DOWN
    ...
    if ((((currentTime - dataTime)/1000000.0) > LOGPERIOD) && (FILEOPEN == 1)) {
      ...
      OUTPUT.set(16,1,pos_data[1]/10000000.0); //lat - Maxwell says it may be lon lat
      OUTPUT.set(17,1,pos_data[2]/10000000.0); //lon
      OUTPUT.set(18,1,pos_data[3]/1000.0); ///height above ellipsoid 1984?
      #endif
      #ifdef USEPITOT
      OUTPUT.set(19,1,adc_result/1000.0);
      #endif
      #ifdef USEBARO
      OUTPUT.set(20,1,baroPressure/1000.0);
      #endif
