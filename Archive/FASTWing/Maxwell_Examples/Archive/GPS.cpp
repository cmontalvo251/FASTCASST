...
int main(int argc, char *argv[]){
  ...
  OUTPUT.zeros(24,1,"OUTPUT MATRIX");
  ...
  while (1) {
    ...
    if ((((currentTime - dataTime)/1000000.0) > 0.02) && (FILEOPEN == 1)) {
      ...
      OUTPUT.set(18,1,pos_data[0]/1000.0);
      OUTPUT.set(19,1,pos_data[1]/10000000.0);
      OUTPUT.set(20,1,pos_data[2]/10000000.0);
      OUTPUT.set(21,1,pos_data[3]/1000.0);
