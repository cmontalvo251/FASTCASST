...
class forces {
 ...
 public:
  double length = 1; //This is the length of the tank. It is used in the Dryden model
  ...
  void ForceMoment(double time,MATLAB state,MATLAB statedot,MATLAB pwm_out,const environment& env); 
  //Constructor
  forces();
};
